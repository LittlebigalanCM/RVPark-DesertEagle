    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MilitaryBranch", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Price_SiteType_SiteTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsLocked = table.Column<bool>(type: "bit", nullable: false),
                    SiteTypeId = table.Column<int>(type: "int", nullable: false),
                    TrailerMaxSize = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_MilitaryStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteTrigger = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsTransactionField = table.Column<bool>(type: "bit", nullable: false),
                    IsPermanent = table.Column<bool>(type: "bit", nullable: false),
                    IsOneTimeUse = table.Column<bool>(type: "bit", nullable: false),
                    ConfirmationLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    NoteAgreeText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoteDisagreeText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgreeRedirectUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DisagreeRedirectUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShowAgreeButtons = table.Column<bool>(type: "bit", nullable: false),
                    DisablePayOnDisagree = table.Column<bool>(type: "bit", nullable: false),
                    IsTriggerField = table.Column<bool>(type: "bit", nullable: false),
                    ReservationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomDynamicField", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomDynamicField_Reservation_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviouslyRefunded = table.Column<bool>(type: "bit", nullable: false),
                    TriggerType = table.Column<int>(type: "int", nullable: false),
                    CalculationType = table.Column<int>(type: "int", nullable: false),
                    TriggerRuleSnapshotJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomDynamicField_ReservationId",
